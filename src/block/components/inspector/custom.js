...
class Custom extends Component {
  render() {
    ...
    const select = prop => value => {
      const data = cloneDeep(attributes.data)
      set(data, prop, value)
      setAttributes({ data })
    }
    ...
    return <InspectorControls>
        ...
        <PanelBody title={ __( 'Episode', 'podlove-web-player' ) } >
          ...
          <PanelRow className="podlove-web-player--row">
            <TextareaControl label={__( 'Summary', 'podlove-web-player' )} value={value('summary')} onChange={compose(select('summary'), event)} />
          </PanelRow>
        </PanelBody>
        ...
        <PanelBody title={ __( 'Show', 'podlove-web-player' ) } >
          ...
          <PanelRow className="podlove-web-player--row">
            <TextareaControl label={__( 'Summary', 'podlove-web-player' )} value={value(['show', 'summary'])} onChange={compose(select(['show', 'summary']), event)} />
          </PanelRow>
        </PanelBody>
